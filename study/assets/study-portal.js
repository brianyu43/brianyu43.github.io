...
const books = [
  ...
  {
    id: "gpumode",
    title: "GPU Mode 104강 한글 리더",
    category: "CUDA/병렬",
    description: "GPU Mode YouTube 시리즈 104편을 OSTEP식 한국어 노트로 다시 엮은 리더입니다. CUDA·Triton·CUTLASS·컴파일러·분산학습·양자화까지 GPU 시스템 엔지니어링의 큰 길을 한 화면에서 이어 읽습니다.",
    href: "../gpumode/index.html",
    tags: ["GPU Mode", "CUDA", "Triton", "CUTLASS", "ML Systems"],
    chapters: [
      ["L001", "프로파일링부터 시작하자", "../gpumode/index.html#lecture-001"],
      ["L002", "CUDA 첫 문법과 PMPP의 관점", "../gpumode/index.html#lecture-002"],
      ["L003", "Python 프로그래머를 위한 CUDA 입문", "../gpumode/index.html#lecture-003"],
      ["L004", "계산과 메모리의 기본값", "../gpumode/index.html#lecture-004"],
      ["L005", "shared memory로 matmul 밀어보기", "../gpumode/index.html#lecture-005"],
      ["L006", "Optimizer는 왜 느려지는가", "../gpumode/index.html#lecture-006"],
      ["L007", "quantization은 dtype 하나가 아니다", "../gpumode/index.html#lecture-007"],
      ["L008", "CUDA 성능 체크리스트", "../gpumode/index.html#lecture-008"],
      ["L009", "reduction을 제대로 접는 법", "../gpumode/index.html#lecture-009"],
      ["L010", "제품용 CUDA 라이브러리 만들기", "../gpumode/index.html#lecture-010"],
      ["L011", "sparsity: 0을 빨리 건너뛰기", "../gpumode/index.html#lecture-011"],
      ["L012", "FlashAttention의 손맛", "../gpumode/index.html#lecture-012"],
      ["L013", "Ring Attention과 긴 문맥", "../gpumode/index.html#lecture-013"],
      ["L014", "Triton은 tile로 생각한다", "../gpumode/index.html#lecture-014"],
      ["L015", "CUTLASS를 읽는 눈", "../gpumode/index.html#lecture-015"],
      ["L016", "프로파일러는 확대경이다", "../gpumode/index.html#lecture-016"],
      ["L017", "NCCL과 all-reduce의 자리", "../gpumode/index.html#lecture-017"],
      ["L018", "Kernel fusion은 왕복을 줄이는 기술이다", "../gpumode/index.html#lecture-018"],
      ["L019", "GPU에서 데이터 처리를 한다는 것", "../gpumode/index.html#lecture-019"],
      ["L020", "Scan, 순차 의존성을 병렬로 펴기", "../gpumode/index.html#lecture-020"],
      ["L021", "Scan 최적화의 세 층", "../gpumode/index.html#lecture-021"],
      ["L022", "Speculative decoding을 vLLM 안에서 보기", "../gpumode/index.html#lecture-022"],
      ["L023", "Tensor Core를 먹여 살리는 일", "../gpumode/index.html#lecture-023"],
      ["L024", "Scan at the Speed of Light", "../gpumode/index.html#lecture-024"],
      ["L025", "AMD Composable Kernel을 말하는 법", "../gpumode/index.html#lecture-025"],
      ["L026", "SYCL로 Intel GPU를 만지기", "../gpumode/index.html#lecture-026"],
      ["L027", "WebGPU로 로컬 GPU를 작게 열기", "../gpumode/index.html#lecture-027"],
      ["L028", "Liger Kernel, 빠른 Triton보다 믿을 수 있는 Triton", "../gpumode/index.html#lecture-028"],
      ["L029", "Triton 안쪽으로 내려가기", "../gpumode/index.html#lecture-029"],
      ["L030", "Quantized Training은 inference보다 까다롭다", "../gpumode/index.html#lecture-030"],
      ["L031", "Metal kernel을 CUDA 눈으로 읽기", "../gpumode/index.html#lecture-031"],
      ["L032", "Unsloth, kernel에서 training library까지", "../gpumode/index.html#lecture-032"],
      ["L033", "BitBLAS, low-bit GEMM을 compiler 문제로 보기", "../gpumode/index.html#lecture-033"],
      ["L034", "Low Bit Triton Kernel의 현실", "../gpumode/index.html#lecture-034"],
      ["L035", "SGLang, GPU를 기다리게 하지 않는 serving", "../gpumode/index.html#lecture-035"],
      ["L036", "FlashAttention 3를 CUTLASS로 읽기", "../gpumode/index.html#lecture-036"],
      ["L037", "SASS를 읽는 이유", "../gpumode/index.html#lecture-037"],
      ["L038", "ARM CPU에서 low-bit LLM을 돌리기", "../gpumode/index.html#lecture-038"],
      ["L039", "TorchTitan을 책처럼 읽기", "../gpumode/index.html#lecture-039"],
      ["L040", "CUDA 문서를 사람 말로 잇기", "../gpumode/index.html#lecture-040"],
      ["L041", "FlashInfer, KV cache를 있는 그대로 다루기", "../gpumode/index.html#lecture-041"],
      ["L042", "Mosaic GPU와 Palace, 낮은 층을 Python으로 쓰기", "../gpumode/index.html#lecture-042"],
      ["L043", "Turing에서 int8 Tensor Core matmul 배우기", "../gpumode/index.html#lecture-043"],
      ["L044", "NVIDIA Profiling, 자료가 부족할 때의 읽기 지도", "../gpumode/index.html#lecture-044"],
      ["L045", "H100에서 cuBLAS를 넘는다는 말", "../gpumode/index.html#lecture-045"],
      ["L046", "Distributed GEMM, 통신까지 포함한 matmul", "../gpumode/index.html#lecture-046"],
      ["L047", "KernelBot, Discord에서 커널을 재는 법", "../gpumode/index.html#lecture-047"],
      ["L048", "Ultra Scale Playbook, 큰 시스템 앞에서 서두르지 않기", "../gpumode/index.html#lecture-048"],
      ["L049", "Low Bit Metal Kernels, Apple 쪽 저정밀 커널", "../gpumode/index.html#lecture-049"],
      ["L050", "CUDA, Triton, FlashAttention 학습 여정", "../gpumode/index.html#lecture-050"],
      ["L051", "Consumer GPU performance, 데이터센터 밖의 GPU", "../gpumode/index.html#lecture-051"],
      ["L052", "Low Precision scaling laws, 숫자와 dtype의 균형", "../gpumode/index.html#lecture-052"],
      ["L053", "torch.compile Q&A, 질문으로 보는 컴파일 경계", "../gpumode/index.html#lecture-053"],
      ["L054", "LeanRL, 작은 RL 모델을 빠르게 굴리는 감각", "../gpumode/index.html#lecture-054"],
      ["L055", "Modular의 unified device accelerator language", "../gpumode/index.html#lecture-055"],
      ["L056", "Kernel Benchmarking Tales, 숫자 뒤의 습관", "../gpumode/index.html#lecture-056"],
      ["L057", "CuTe, layout을 계산하는 법", "../gpumode/index.html#lecture-057"],
      ["L058", "Disaggregated LLM Inference, prefill과 decode를 떼어 보기", "../gpumode/index.html#lecture-058"],
      ["L059", "FastVideo, 이름만 남은 강의를 읽는 법", "../gpumode/index.html#lecture-059"],
      ["L060", "Optimizing Linear Attention, 선형화 뒤에도 남는 병목", "../gpumode/index.html#lecture-060"],
      ["L061", "D-Matrix Corsair, 모르는 이름을 모르는 채로 두기", "../gpumode/index.html#lecture-061"],
      ["L062", "Exo 2, scheduling language를 키운다는 것", "../gpumode/index.html#lecture-062"],
      ["L063", "Search-Based Deep Learning Compilers, 탐색이 컴파일러가 될 때", "../gpumode/index.html#lecture-063"],
      ["L064", "Multi-GPU programming, 여러 GPU를 하나처럼 쓰지 않기", "../gpumode/index.html#lecture-064"],
      ["L065", "Neighborhood Attention, 가까운 곳만 보는 attention", "../gpumode/index.html#lecture-065"],
      ["L066", "Game Arena, 정적 benchmark 밖에서 reasoning 보기", "../gpumode/index.html#lecture-066"],
      ["L067", "NCCL과 NVSHMEM, collective와 one-sided 사이", "../gpumode/index.html#lecture-067"],
      ["L068", "GPU 중심 communication, 지형도를 그리기 전에", "../gpumode/index.html#lecture-068"],
      ["L069", "Quartet, FP4 training을 진짜 학습 문제로 다루기", "../gpumode/index.html#lecture-069"],
      ["L070", "PCCL, fault tolerant collective를 묻다", "../gpumode/index.html#lecture-070"],
      ["L071", "FlexOlmo, data를 섞지 않고 함께 학습하기", "../gpumode/index.html#lecture-071"],
      ["L072", "StreamingLLM, long-context를 KV cache 문제로 보기", "../gpumode/index.html#lecture-072"],
      ["L073", "Large model quantization, 낮출 곳을 먼저 고르기", "../gpumode/index.html#lecture-073"],
      ["L074", "RoPE, YaRN, PaTH로 position을 다시 보기", "../gpumode/index.html#lecture-074"],
      ["L075", "GPU Programming Fundamentals와 ThunderKittens", "../gpumode/index.html#lecture-075"],
      ["L076", "BackendBench, 빠른 kernel보다 맞는 kernel", "../gpumode/index.html#lecture-076"],
      ["L077", "GPU kernel DSL, 무엇을 숨기고 무엇을 드러낼까", "../gpumode/index.html#lecture-077"],
      ["L078", "Iris, Triton 안에서 multi-GPU를 일급 시민으로", "../gpumode/index.html#lecture-078"],
      ["L079", "Mirage와 mega-kernel, launch를 줄이는 더 큰 질문", "../gpumode/index.html#lecture-079"],
      ["L080", "FlashAttention 4를 읽는 법", "../gpumode/index.html#lecture-080"],
      ["L081", "Functional arrays, 순수한 식이 GPU code가 되기까지", "../gpumode/index.html#lecture-081"],
      ["L082", "Helion, ML kernel DSL이 높아져도 남는 일", "../gpumode/index.html#lecture-082"],
      ["L083", "kernel derivation, 빠른 코드를 증명하듯 만들기", "../gpumode/index.html#lecture-083"],
      ["L084", "numerics, AI가 숫자를 대하는 태도", "../gpumode/index.html#lecture-084"],
      ["L085", "Factorio Learning Environment, RL 환경을 시스템으로 보기", "../gpumode/index.html#lecture-085"],
      ["L086", "CuTe DSL, tile을 언어로 생각하기", "../gpumode/index.html#lecture-086"],
      ["L087", "NVSHMEM, communication을 kernel 가까이로", "../gpumode/index.html#lecture-087"],
      ["L088", "TinyTPU, 축소 모형으로 accelerator 읽기", "../gpumode/index.html#lecture-088"],
      ["L089", "cuTile, tile abstraction을 어디까지 믿을까", "../gpumode/index.html#lecture-089"],
      ["L090", "Resilient ML engineering, 오래 가는 실력의 바닥", "../gpumode/index.html#lecture-090"],
      ["L091", "RL/OpenEnv, agent 실험을 재현 가능한 시스템으로", "../gpumode/index.html#lecture-091"],
      ["L092", "Smol Training Playbook, 작게 훈련하며 크게 배우기", "../gpumode/index.html#lecture-092"],
      ["L093", "Cornserve, 멀티모달 serving을 쉽게 만든다는 말의 무게", "../gpumode/index.html#lecture-093"],
      ["L094", "tvm-ffi, compiler와 runtime 사이의 얇지만 중요한 문", "../gpumode/index.html#lecture-094"],
      ["L095", "Monarch와 single controller programming", "../gpumode/index.html#lecture-095"],
      ["L096", "TLX, Triton 너머의 kernel 언어를 읽는 법", "../gpumode/index.html#lecture-096"],
      ["L097", "HipKittens, 이름이 귀여워도 portability는 진지하다", "../gpumode/index.html#lecture-097"],
      ["L098", "GPU Observability, 빠른지보다 먼저 보이는지", "../gpumode/index.html#lecture-098"],
      ["L099", "Consumer device 위의 distributed ML", "../gpumode/index.html#lecture-099"],
      ["L100", "InferenceX, 계속 재는 inference benchmark", "../gpumode/index.html#lecture-100"],
      ["L101", "CUTLASS를 어려운 길로 배우기", "../gpumode/index.html#lecture-101"],
      ["L102", "quartet v2, 이름만 남았을 때 시스템 강의를 읽는 법", "../gpumode/index.html#lecture-102"],
      ["L103", "CuTe layout algebra, 주소 계산을 수학으로 붙잡기", "../gpumode/index.html#lecture-103"],
      ["L104", "Gluon과 Linear Layouts, 낮게 내려가되 손잡이는 남기기", "../gpumode/index.html#lecture-104"]
    ]
  }
];
...
function renderLibrary() {
  ...
  libraryEl.innerHTML = orderedBooks.map((book) => {
    ...
    return `
      <article id="${book.id}" class="book-card${isVisible ? "" : " hidden"}" data-book="${book.id}">
        <div class="book-head">
          <div>
...
function openHashTarget() {
  ...
  const card = Array.from(libraryEl.querySelectorAll("[data-book]"))
    .find((candidate) => candidate.dataset.book === id);
  if (!card || card.classList.contains("hidden")) return;

  const button = card.querySelector("[data-toggle]");
  if (button && !card.classList.contains("expanded")) {
    card.classList.add("expanded");
    button.setAttribute("aria-expanded", "true");
    button.textContent = "챕터 닫기";
  }
